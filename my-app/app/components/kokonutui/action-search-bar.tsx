...
const allActionsSample = [
    ...
    },
    {
        ...
        description: "consulter-telecharger",
        short: "",
        end: "",
    },
    {
                ...
                <div className="w-full max-w-sm sticky top-0 z-10 pt-4 pb-1 ">
                    ...
                    <div className="relative ">
                        <Input
                            ...
                            id="search"
                            autoComplete="off"
                            className="pl-3 pr-9 py-1.5 h-9 text-sm rounded-lg focus-visible:ring-offset-0 backdrop-blur-sm "
                        />
                ...
                <div className="w-full max-w-sm ">
                    <AnimatePresence>
                        {isFocused && result && !selectedAction && (
                            <motion.div
                                className="w-full border rounded-md shadow-xs overflow-hidden dark:border-gray-800 bg-white dark:bg-black mt-1 relative top-30"
