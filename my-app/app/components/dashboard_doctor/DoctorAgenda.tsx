...
const DoctorAgenda = () => {
  ...
  try {
    ...
    const startOfWeek = weekDays[0].toISOString().split('T')[0];
        ...
        const response = await axios.get('http://127.0.0.1:8000/api/doctors/appointments', {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      case 'confirmed': return 'bg-gradient-to-br from-blue-500 to-blue-600';
      case 'pending': return 'bg-gradient-to-br from-yellow-500 to-yellow-600';
      case 'completed': return 'bg-gradient-to-br from-green-500 to-green-600';
      case 'cancelled': return 'bg-gradient-to-br from-red-500 to-red-600';
  ...
  return (
    <div className="w-full h-screen bg-background from-slate-50 to-slate-100 p-6">
      {/* Header */}
      <div className="bg-white rounded-2xl shadow-lg p-6 mb-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-800">Planning de la semaine</h1>
      ...
      <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
        ...
        <div className="grid grid-cols-8 border-b border-gray-200 bg-gradient-to-r from-slate-50 to-slate-100">
          ...
          {weekDays.map((day, idx) => (
            ...
            >
              <div className={`font-bold ${isToday(day) ? 'text-blue-600' : 'text-gray-800'}`}>
                {day.toLocaleDateString('fr-FR', { weekday: 'short' })}
              </div>
              <div className={`text-sm mt-1 ${isToday(day) ? 'text-blue-500' : 'text-gray-500'}`}>
      ...
      {selectedAppointment && (
        ...
        >
          ...
          >
            <h2 className="text-2xl font-bold text-gray-800 mb-6">Détails du rendez-vous</h2>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">{selectedAppointment.patient.telephone}</p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-lg font-semibold text-gray-800">{selectedAppointment.consultation_type}</p>
                </div>
              </div>
