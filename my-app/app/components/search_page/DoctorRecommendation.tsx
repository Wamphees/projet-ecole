...
import { X, Sparkles, User, Stethoscope, Building2, Clock, CheckCircle2, AlertCircle } from 'lucide-react';
                        ...
                        <div className="space-y-3">
                          {result.doctors.map((doctor) => (
                            <motion.div
                              ...
                              className="bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 rounded-xl p-4 hover:border-purple-500 hover:shadow-lg transition-all duration-200 cursor-pointer group"
                              onClick={() => onSelectDoctor?.(doctor.id)}
                            >
                              <div className="flex items-start justify-between">
                                <div className="flex-1">
                                  <div className="flex items-center gap-2 mb-2">
                                    <h4 className="font-bold text-lg text-gray-900 dark:text-white group-hover:text-purple-600 transition-colors">
                                      {doctor.name}
                                    </h4>
